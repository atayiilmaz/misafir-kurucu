...
export function Navbar1({ items }: Navbar1Props) {
  ...
  return (
    <header className="sticky top-0 z-50 px-3 pt-3 md:px-4">
      <div className="mx-auto flex w-full max-w-[90rem] items-center justify-between rounded-full border border-white/70 bg-white/85 px-4 py-3 shadow-soft backdrop-blur md:px-5">
        <AppLink href="/" className="flex items-center gap-3">
          ...
          <div>
            <p className="font-display text-2xl leading-none">MK</p>
        ...
        <button
          className="inline-flex items-center rounded-full p-2 text-foreground md:hidden"
